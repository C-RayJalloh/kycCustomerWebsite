  ...
  return (
    <Card className="w-full max-w-md mx-auto shadow-lg ">
      <CardHeader className="bg-primary text-primary-foreground rounded-t-lg">
        <CardTitle className="text-3xl font-bold text-center">QCell KYC Verification</CardTitle>
        <CardDescription className="text-center text-primary-foreground/80">Complete your Know Your Customer (KYC) process</CardDescription>
      </CardHeader>
      <CardContent className="text-center mt-6">
        <p className="mb-4">Welcome to QCell&rsquo;s KYC verification process. This helps us ensure the security of our services and comply with regulations.</p>
        <p className="mb-4 font-semibold">Please have the following information ready:</p>
      ...
      <CardFooter className="flex justify-center">
        <Link to="/kycForm">
          <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground">Start KYC Process</Button>
        </Link>
      </CardFooter>
    </Card>
  )
